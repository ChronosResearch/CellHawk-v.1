...
mod test_v2_encode_decode {
    ...
    pub fn test_write_v2_heartbeat() {
        ...
        mavlink::write_v2_msg(
            ...
            &mavlink::dialects::common::MavMessage::HEARTBEAT(heartbeat_msg),
        )
    ...
    pub fn test_read_truncated_command_long() {
        ...
        if let mavlink::dialects::common::MavMessage::COMMAND_LONG(recv_msg) = recv_msg {
            assert_eq!(
                recv_msg.command,
                mavlink::dialects::common::MavCmd::MAV_CMD_SET_MESSAGE_INTERVAL
            );
        } else {
            panic!("Decoded wrong message type")
        }
    ...
    pub fn test_echo_servo_output_raw() {
        ...
        mavlink::write_v2_msg(
            &mut v,
            crate::test_shared::COMMON_MSG_HEADER,
            &mavlink::dialects::common::MavMessage::SERVO_OUTPUT_RAW(send_msg.clone()),
        )
        .expect("Failed to write message");
    ...
    pub fn test_decode_encode_v2_frame_parameter_value_hash_check() {
        ...
        assert_eq!(
            ...
            mavlink::dialects::common::MavParamType::MAV_PARAM_TYPE_UINT32
        );
