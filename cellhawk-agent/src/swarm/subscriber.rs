...
pub async fn run_subscriber(client: &redis::Client, costmap: Arc<Mutex<Vec<Hazard>>>) -> Result<(), redis::RedisError> {
...
pub async fn query_hazards_nearby(client: &redis::Client, lon: f64, lat: f64) -> Result<Vec<String>, redis::RedisError> {
